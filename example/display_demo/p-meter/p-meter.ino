...
void analogMeter()
{
  ...
  tft.drawString(union_text, M_SIZE * (5 + 230 - 40), M_SIZE * (119 - 20), 2); // Units at bottom right
  tft.drawCentreString(union_text, M_SIZE * 120, M_SIZE * 70, 4);              // Comment out to avoid font 4
